...
sap.ui.define([
	...
	return BaseController.extend("live5.ui.controller.Detail", {
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("Clusters", {
					clusterNumber: sObjectId
				});
		...
		_onBindingChange: function() {
			...
			var sPath = decodeURI(oElementBinding.getPath()),
				...
				sObjectId = oObject.clusterNumber,
				sObjectName = oObject.clusterNumber,
				oViewModel = this.getModel("detailView");
