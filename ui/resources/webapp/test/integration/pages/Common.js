sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("live5/ui/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("live5.ui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["live5/ui/localService/mockserver"], function (mockserver) {
