sap.ui.define([
		...
		opaTest("MasterList Filtering on users less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("users").
				and.iSelectListItemInViewSettingsDialog("<100 users").
		...
		opaTest("MasterList Filtering on users more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 users").
				and.iPressOKInViewSelectionDialog();
